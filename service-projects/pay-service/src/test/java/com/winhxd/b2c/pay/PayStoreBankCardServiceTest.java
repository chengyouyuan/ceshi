...
//	private BigDecimal maxMoney;
	...
	public void testRefund(){
		PayRefundCondition condition = new PayRefundCondition();
		condition.setTotalAmount(new BigDecimal("10"));
		condition.setRefundAmount(new BigDecimal("10"));
		condition.setRefundDesc("test");
		condition.setOutTradeNo("15408640527");
		PayRefundVO payRefundVO = wxRefundService.refundOrder(condition);
		System.out.println(payRefundVO.toString());
	}
}
