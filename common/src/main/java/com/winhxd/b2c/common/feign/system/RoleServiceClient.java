...
public interface RoleServiceClient {
     ...
     * @return
     */
    @RequestMapping(value = "/role/3100/v1/add", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "/role/3101/v1/update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "/role/3102/v1/list", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "/role/3103/v1/get/{id}", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/role/3104/v1/remove/{id}", method = RequestMethod.DELETE)
