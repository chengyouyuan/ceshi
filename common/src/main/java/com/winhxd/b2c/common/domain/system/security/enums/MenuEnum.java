...
public enum MenuEnum {
    ...
    PROMOTION_TEMPLETE_MANAGEMENT_ADD("模板新增", PROMOTION_TEMPLETE_MANAGEMENT, "", "/promotion/addtemplate", PermissionEnum.PROMOTION_TEMPLETE_MANAGEMENT_ADD),
    PROMOTION_TEMPLETE_MANAGEMENT_LIST("模板列表", PROMOTION_TEMPLETE_MANAGEMENT, "/template/module/promotion/coupon_templete_list.json", PermissionEnum.PROMOTION_TEMPLETE_MANAGEMENT_LIST),
