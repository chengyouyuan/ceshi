 ...
 *         漫道  惠下单通道
 */
public class ManDaoSmsProcess extends SmsProcess {

    @Override
    public int sendMessage(MessageSmsHistory smsSend) {
        try {
            Client client = new Client();
            String result_mt = client.mt(smsSend.getTelephone(), smsSend.getContent() + "[惠下单]", "", "", "");
    ...
    public static void main(String args[]) {
        ...
        smsSend.setContent("值此新春佳节来临之际，惠下单全体同仁恭祝您马年马到成功，龙马精神。事业一马当先。");
        smsSend.setTelephone("18701243491");
