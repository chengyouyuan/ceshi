...
public class OrderInfoSimpleVo {
     ...
     * 9:待自提(已确认);10:待送货(已确认);11:待顾客确认;13:已完成;99:已取消;77:已退款;33:待退款;
     */
    @ApiModelProperty(value = "订单状态 1:已提交;3:待接单;5:待计价;7:已计价;9:待自提(已确认);10:待送货(已确认);11:待顾客确认;13:已完成;99:已取消;77:已退款;33:待退款;", required = true)
