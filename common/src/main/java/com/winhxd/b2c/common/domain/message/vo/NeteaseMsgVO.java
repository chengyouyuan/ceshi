...
public class NeteaseMsgVO {
    ...
    @ApiModelProperty("页面类型 1-新订单 2-已完成 3-已退款 4-已取消 5-申请退款 10-提现申请 11-提现成功 12-提现失败 13 惠小店通知")
    private Short pageType;

    @ApiModelProperty("消息类型简述 新订单 已完成 已退款 已取消 申请退款 提现申请 提现成功 提现失败 惠小店通知")
    private String pageTypeSummary;

    @ApiModelProperty("消息类型描述 新 完 退 取 申 提 现 败 惠")
