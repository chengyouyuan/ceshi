...
public interface RoleServiceClient {
     ...
     * @return
     */
    @RequestMapping(value = "/role/306/v1/add", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "/role/307/v1/update", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "/role/308/v1/list", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "/role/309/v1/get/{id}", method = RequestMethod.GET)
