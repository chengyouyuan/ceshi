...
public class SmsConstant {
	 ...
	 * 漫道注册校验
	 */
	public static final String SMS_MANDAO_REGISTER_PATTERN = "<RegisterResult>(.*)</RegisterResult>";

	/**
	 * 漫道费用校验
	 */
	public static final String SMS_MANDAO_CHECKFEE_PATTERN = "<ChargUpResult>(.*)</ChargUpResult>";
	/**
	 * 漫道获取余额
	 */
	public static final String SMS_MANDAO_GETBALANCE_PATTERN = "<balanceResult>(.*)</balanceResult>";
	/**
	 * 漫道发送短信结果校验
	 */
	public static final String SMS_MANDAO_MT_PATTERN = "<mtResult>(.*)</mtResult>";
	/**
	 * 漫道发送个性短信校验
	 */
	public static final String SMS_MANDAO_GXMT_PATTERN = "<gxmtResult>(.*)</gxmtResult>";
	/**
	 * 漫道发送个性短信校验
	 */
	public static final String SMS_MANDAO_UNREGISTER_PATTERN = "<UnRegisterResult>String</UnRegisterResult>";
	/**
	 * 漫道发送个性短信校验
	 */
	public static final String SMS_MANDAO_UDPPWD_PATTERN = "<UDPPwdResult>(.*)</UDPPwdResult>";
	/**
	 * 发彩信方法
	 */
	public static final String SMS_MANDAO_MDMMSSEND_PATTERN = "<mdMmsSendResult>(.*)</mdMmsSendResult>";
	/**
	 * 发送错误标识
	 */
	public static final String SEND_FAIL_IDENTIFY = "-";
	/**
	 * 连接/读取 超时时间 300毫秒
	 */
